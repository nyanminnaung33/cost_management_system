...
export function TemporaryOverseasCostSalesComparison() {
  ...
  return (
    <div className="space-y-6">
      {/* Page Header */}
      <div>
        <h1 className="text-2xl font-semibold text-gray-900">海外費用仮インポート売上照合</h1>
        <p className="text-gray-600 mt-1">frmPG0323 - Temporary Overseas Cost Sales Comparison</p>
      </div>
